  ...
  return [
    {
      ...
      // One seeded description so the card's note block is exercised in a
      // keyless dev environment.
      description:
        "Rework the pricing slide and cut the roadmap section down to one page.",
      priority: "high",
